...
public class MultipleSelectionBarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public MultipleSelectionBarAdapter(CalendarView calendarView,
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    if (viewType == VIEW_TYPE_TITLE) {
      return new TitleViewHolder(LayoutInflater.from(parent.getContext())
          .inflate(R.layout.item_multiple_selection_bar_title, parent, false));
    } else {
      return new ContentViewHolder(LayoutInflater.from(parent.getContext())
          .inflate(R.layout.item_multiple_selection_bar_content, parent, false));
    }
  }
  ...
  public class ContentViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(int position) {
      final SelectionBarContentItem selectionBarContentItem =
          (SelectionBarContentItem) items.get(position);
      ...
      itemView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
          if (listItemClickListener != null) {
            listItemClickListener.onMultipleSelectionListItemClick(
                selectionBarContentItem.getDay());
          }
        }
      });
    }
