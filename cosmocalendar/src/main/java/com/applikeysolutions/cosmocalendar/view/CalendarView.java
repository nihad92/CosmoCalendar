...
import com.applikeysolutions.cosmocalendar.utils.snap.GravityPagerSnapHelper;
...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
  ...
  private RecyclerView.OnScrollListener pagingScrollListener = new RecyclerView.OnScrollListener() {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
      ...
      View view = rvMonths.getLayoutManager()
          .findViewByPosition(getFirstVisiblePosition(rvMonths.getLayoutManager()));
      if (view != null) {
        view.requestLayout();
      }
  ...
  private void handleAttributes(AttributeSet attrs, int defStyle, int defStyleRes) {
    ...
    final TypedArray typedArray = getContext().getTheme()
        .obtainStyledAttributes(attrs, R.styleable.CalendarView, defStyle, defStyleRes);
    try {
  ...
  private void handleAttributes(TypedArray typedArray) {
    int orientation = typedArray.getInteger(R.styleable.CalendarView_orientation,
        SettingsManager.DEFAULT_ORIENTATION);
    int firstDayOfWeek = typedArray.getInteger(R.styleable.CalendarView_firstDayOfTheWeek,
        SettingsManager.DEFAULT_FIRST_DAY_OF_WEEK);
    int selectionType = typedArray.getInteger(R.styleable.CalendarView_selectionType,
        SettingsManager.DEFAULT_SELECTION_TYPE);
    ...
    int calendarBackgroundColor =
        typedArray.getColor(R.styleable.CalendarView_calendarBackgroundColor,
    ...
    int weekendDayTextColor = typedArray.getColor(R.styleable.CalendarView_weekendDayTextColor,
        ContextCompat.getColor(getContext(), R.color.default_weekend_day_text_color));
    ...
    int selectedDayBackgroundColor =
        typedArray.getColor(R.styleable.CalendarView_selectedDayBackgroundColor,
            ContextCompat.getColor(getContext(), R.color.default_selected_day_background_color));
    int selectedDayBackgroundStartColor =
        typedArray.getColor(R.styleable.CalendarView_selectedDayBackgroundStartColor,
            ContextCompat.getColor(getContext(),
                R.color.default_selected_day_background_start_color));
    int selectedDayBackgroundEndColor =
        typedArray.getColor(R.styleable.CalendarView_selectedDayBackgroundEndColor,
            ContextCompat.getColor(getContext(),
                R.color.default_selected_day_background_end_color));
    ...
    int currentDaySelectedIconRes =
        typedArray.getResourceId(R.styleable.CalendarView_currentDaySelectedIconRes, 0);
    int connectedDayIconRes =
        typedArray.getResourceId(R.styleable.CalendarView_connectedDayIconRes, 0);
    int connectedDaySelectedIconRes =
        typedArray.getResourceId(R.styleable.CalendarView_connectedDaySelectedIconRes, 0);
    int connectedDayIconPosition =
        typedArray.getInteger(R.styleable.CalendarView_connectedDayIconPosition,
            SettingsManager.DEFAULT_CONNECTED_DAY_ICON_POSITION);
    int disabledDayTextColor = typedArray.getColor(R.styleable.CalendarView_disabledDayTextColor,
        ContextCompat.getColor(getContext(), R.color.default_disabled_day_text_color));
    int selectionBarMonthTextColor =
        typedArray.getColor(R.styleable.CalendarView_selectionBarMonthTextColor,
            ContextCompat.getColor(getContext(),
                R.color.default_selection_bar_month_title_text_color));
    int previousMonthIconRes =
        typedArray.getResourceId(R.styleable.CalendarView_previousMonthIconRes,
            R.drawable.ic_chevron_left_gray);
    int nextMonthIconRes = typedArray.getResourceId(R.styleable.CalendarView_nextMonthIconRes,
        R.drawable.ic_chevron_right_gray);
    float weekDayTitleTextSize =
        typedArray.getDimension(R.styleable.CalendarView_weekDayTitleTextSize,
            this.getResources().getDimension(R.dimen.day_text_size));
    float monthTextSize =
        typedArray.getDimension(R.styleable.CalendarView_monthTextSize,
            this.getResources().getDimension(R.dimen.text_big));
    float dayTextSize =
        typedArray.getDimensionPixelSize(R.styleable.CalendarView_dayTextSize,
            this.getResources().getDimensionPixelSize(R.dimen.day_text_size));
    float selectedDayTextSize =
        typedArray.getDimension(R.styleable.CalendarView_selectedDayTextSize,
            this.getResources().getDimension(R.dimen.day_text_size));
    ...
    settingsManager.setWeekDayTitleTextSize(weekDayTitleTextSize);
  ...
  private void handleWeekendDaysAttributes(TypedArray typedArray) {
    if (typedArray.hasValue(R.styleable.CalendarView_weekendDays)) {
      ...
      int weekdaysAttr =
          typedArray.getInteger(R.styleable.CalendarView_weekendDays, WeekDay.SUNDAY);
  ...
  private void setDaysOfWeekTitles() {
    settingsManager.setShowDaysOfWeekTitle(
        settingsManager.getCalendarOrientation() != LinearLayoutManager.HORIZONTAL);
    settingsManager.setShowDaysOfWeek(
        settingsManager.getCalendarOrientation() == LinearLayoutManager.HORIZONTAL);
  ...
  private void createDaysOfWeekTitle() {
    ...
    if (!isTitleAlreadyAdded) {
      ...
      llDaysOfWeekTitles.setLayoutParams(
  ...
  private void createBottomSelectionBar() {
    ...
    flBottomSelectionBar.setVisibility(
        settingsManager.getCalendarOrientation() == OrientationHelper.HORIZONTAL ? View.VISIBLE
            : View.GONE);
  ...
  private void createMultipleSelectionBarRecycler() {
    ...
    rvMultipleSelectedList.setLayoutParams(
        new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.MATCH_PARENT));
    rvMultipleSelectedList.setLayoutManager(
  ...
  private void createRangeSelectionLayout() {
    llRangeSelection = (LinearLayout) ((LayoutInflater) getContext().getSystemService(
        Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.view_selection_bar_range, null);
    llRangeSelection.setLayoutParams(
        new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT));
  ...
  private void createRecyclerView() {
    ...
    rvMonths.setLayoutManager(
        new LinearLayoutManager(getContext(), settingsManager.getCalendarOrientation(), false));
  ...
  private void createNavigationButtons() {
    ...
    flNavigationButtons =
        (FrameLayout) inflater.inflate(R.layout.calendar_navigation_buttons, this, false);
  ...
  private void loadAsyncMonths(final boolean future) {
    ...
    asyncTask.execute(
        new FetchMonthsAsyncTask.FetchParams(future, month, settingsManager, monthAdapter,
  ...
  public List<Day> getSelectedDays() {
    ...
    for (Iterator<Month> monthIterator = monthAdapter.getData().iterator();
        monthIterator.hasNext(); ) {
      Month month = monthIterator.next();
      for (Iterator<Day> dayIterator = month.getDaysWithoutTitlesAndOnlyCurrent().iterator();
          dayIterator.hasNext(); ) {
  ...
  private void displaySelectedDaysMultiple() {
    multipleSelectionBarAdapter.setData(
        CalendarUtils.getSelectedDayListForMultipleMode(selectedDays));
  }
  ...
  private void displaySelectedDaysRange() {
    if (selectionManager instanceof RangeSelectionManager) {
      ...
      if (days != null) {
        ...
        TextView tvStartRangeTitle =
            (TextView) llRangeSelection.findViewById(R.id.tv_range_start_date);
        ...
        CircleAnimationTextView catvStart =
            (CircleAnimationTextView) llRangeSelection.findViewById(R.id.catv_start);
        ...
        CircleAnimationTextView catvEnd =
            (CircleAnimationTextView) llRangeSelection.findViewById(R.id.catv_end);
        ...
        CircleAnimationTextView catvMiddle =
            (CircleAnimationTextView) llRangeSelection.findViewById(R.id.catv_middle);
  ...
  private boolean needToShowSelectedDaysRange() {
    if (getCalendarOrientation() == OrientationHelper.HORIZONTAL
        && getSelectionType() == SelectionType.RANGE) {
      if (selectionManager instanceof RangeSelectionManager) {
  ...
  private void setSelectionBarVisibility() {
    flBottomSelectionBar.setVisibility(
        getCalendarOrientation() == OrientationHelper.HORIZONTAL ? View.VISIBLE : View.GONE);
  ...
  @Override public float getWeekDayTitleTextSize() {
    return settingsManager.getWeekDayTitleTextSize();
  }
  ...
  @Override public float getMonthTextSize() {
    return settingsManager.getMonthTextSize();
  }
  ...
  @Override public float getDayTextSize() {
    return settingsManager.getDayTextSize();
  }

  @Override public float getSelectedDayTextSize() {
    return settingsManager.getSelectedDayTextSize();
  }
  ...
  private void changeSnapHelper() {
    if (snapHelper == null) {
      snapHelper = new GravityPagerSnapHelper(
          settingsManager.getCalendarOrientation() == LinearLayoutManager.VERTICAL ? Gravity.TOP
              : Gravity.START, true, this);
  ...
  public void onSnap(int position) {
    ...
    if (onMonthChangeListener != null
        && (previousSelectedMonth == null || !previousSelectedMonth.getMonthName()
        .equals(month.getMonthName()))) {
