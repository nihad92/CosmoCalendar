...
import com.applikeysolutions.cosmocalendar.view.delegate.DisabledDayDelegate;
...
public class DaysAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private DisabledDayDelegate disabledDayDelegate;
  ...
  private DaysAdapter(Month month,
      ...
      DisabledDayDelegate disabledDayDelegate,
    ...
    this.disabledDayDelegate = disabledDayDelegate;
  ...
  public int getItemViewType(int position) {
    ...
    if (month.getDays().get(position).isDisabled()) {
      return ItemViewType.DISABLED_DAY;
    }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    switch (viewType) {
      case ItemViewType.DISABLED_DAY:
        return disabledDayDelegate.onCreateDayHolder(parent, viewType);
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    switch (holder.getItemViewType()) {
      ...
      case ItemViewType.OTHER_MONTH_DAY:
        ...
        break;
      case ItemViewType.DISABLED_DAY:
        disabledDayDelegate.onBindDayHolder(day, (DisabledDayHolder) holder, position);
        break;
      case ItemViewType.MONTH_DAY:
  ...
  public static class DaysAdapterBuilder {
    ...
    public DaysAdapterBuilder setDisabledDayDelegate(
        DisabledDayDelegate disabledDayDelegate) {
      this.disabledDayDelegate = disabledDayDelegate;
      return this;
    }
    ...
    public DaysAdapter createDaysAdapter() {
      return new DaysAdapter(month, dayOfWeekDelegate, dayDelegate, anotherDayDelegate,
          disabledDayDelegate,
          calendarView);
    }
  }
