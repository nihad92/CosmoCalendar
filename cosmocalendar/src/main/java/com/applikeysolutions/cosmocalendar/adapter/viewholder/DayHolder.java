...
public class DayHolder extends BaseDayHolder {
  ...
  public void bind(Day day, BaseSelectionManager selectionManager) {
    ...
    if (day.isCurrent()) {
      ...
      ctvDay.setTextColor(isSelected ? calendarView.getSelectedDayTextColor()
          : calendarView.getCurrentDayTextColor());
    }
  ...
  private int getCurrentDayIconHeight(boolean isSelected) {
    if (isSelected) {
      return CalendarUtils.getIconHeight(calendarView.getContext().getResources(),
          calendarView.getCurrentDaySelectedIconRes());
    } else {
      return CalendarUtils.getIconHeight(calendarView.getContext().getResources(),
          calendarView.getCurrentDayIconRes());
    }
  }
  ...
  private void select(Day day) {
    if (day.isFromConnectedCalendar()) {
      ...
      ctvDay.setTextSize(TypedValue.COMPLEX_UNIT_PX, calendarView.getSelectedDayTextSize());
  ...
  private void unselect(Day day) {
    ...
    ctvDay.setTextSize(TypedValue.COMPLEX_UNIT_PX,calendarView.getDayTextSize());
    ctvDay.clearView();
  }
