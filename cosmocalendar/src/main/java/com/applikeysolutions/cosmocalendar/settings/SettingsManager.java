...
public class SettingsManager
    implements AppearanceInterface, DateInterface, CalendarListsInterface, SelectionInterface {
  ...
  public void setWeekDayTitleTextSize(float weekDayTitleTextSize) {
    appearanceModel.setWeekDayTitleTextSize(weekDayTitleTextSize);
  }

  public float getWeekDayTitleTextSize() {
    return appearanceModel.getWeekDayTitleTextSize();
  }

  public void setMonthTextSize(float monthTextSize) {
    appearanceModel.setMonthTextSize(monthTextSize);
  }

  public float getMonthTextSize() {
    return appearanceModel.getMonthTextSize();
  }

  public void setDayTextSize(float dayTextSize) {
    appearanceModel.setDayTextSize(dayTextSize);
  }

  public float getDayTextSize() {
    return appearanceModel.getDayTextSize();
  }

  public void setSelectedDayTextSize(float selectedDayTextSize) {
    appearanceModel.setSelectedDayTextSize(selectedDayTextSize);
  }

  public float getSelectedDayTextSize() {
    return appearanceModel.getSelectedDayTextSize();
  }
}
