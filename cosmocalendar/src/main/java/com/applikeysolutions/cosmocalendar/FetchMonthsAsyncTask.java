...
public class FetchMonthsAsyncTask
    extends AsyncTask<FetchMonthsAsyncTask.FetchParams, Void, List<Month>> {
  ...
  public static class FetchParams {
    ...
    public FetchParams(boolean future, Month month, SettingsManager settingsManager,
        MonthAdapter monthAdapter, int defaultMonthCount) {
      this.future = future;
      this.month = month;
